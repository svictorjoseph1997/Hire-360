<?php /* C:\xampp\htdocs\newpro\resources\views/project/my_project.blade.php */ ?>
                           ...
                           <div class="project-list-wrap">
                              <h2 class="project-list-title">
                                 <a  class="secondary-color" href="https://freelanceengine.enginethemes.com/project/wordpress-plugins-for-gravatars-authors-and-tweets/" title="WordPress Plugins For Gravatars, Authors and Tweets">
                                    ...
                                    <?php echo e($project->project_title); ?>
                              ...
                              <div class="project-list-info">
                                 ...
                                 <span><?php echo e($project->creator_name); ?></span>
                                 
                              </div>
                              <div class="project-list-desc">
                                 <p>  <?php echo e($project->project_body); ?>  </p>
                              </div>
                              <div class="project-list-skill"><span class="fre-label"><a href="https://freelanceengine.enginethemes.com/projects/?skill_project=html"><?php echo e($project->skills_required); ?></a></span></div>
