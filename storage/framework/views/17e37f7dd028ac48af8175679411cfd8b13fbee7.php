<?php /* C:\xampp\htdocs\newpro\resources\views/feedback.blade.php */ ?>
<?php $__env->startSection('content'); ?><div class="fre-page-wrapper">
                           ...
                           <form action="/submit_feedback" method="POST">
                              ...
                              <div class="row">
                                 <select style="width: 230px;height: 45px;font-size: 22px;" name="name">
                                    <?php $__currentLoopData = $hirelings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hireling): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option><?php echo e($hireling->name); ?></option>
