<?php /* C:\xampp\htdocs\newpro\resources\views/project/view_projects.blade.php */ ?>
                                    ...
                                    <li class="project-item">
                                       <div class="project-list-wrap">
                                          <h2 class="project-list-title">
                                             <a  class="secondary-color" href="/view_project/<?php echo e($project->id); ?>" >
                                          ...
                                          <div class="project-list-info">
                                             ...
                                             <span>Total Cost <?php echo e($project->cost_per_hour); ?></span>
